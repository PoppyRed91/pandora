...
let tl3 = gsap.timeline({scrollTrigger: {trigger: "#scene-5-background", scrub: 1}})
...
let tl4 = gsap.timeline({scrollTrigger: {trigger: "#scene-5-pandora", start: "top bottom+=300px", end:"top top", scrub: 1}})
  .to("#scene-5-pandora", {
  opacity: 0.8,
  ease: "power3.out",
}).to("#scene-5-smoke", {
